...
const Register = () => {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      let errorMessage = 'Erreur de création de compte avec Google'
  ...
  const handleAppleRegister = async () => {
    ...
    try {
      ...
      let errorMessage = 'Erreur de création de compte avec Apple'
      ...
      setError(errorMessage)
      console.error('Erreur inscription Apple:', err)
      setLoading(false)
    }
  }
    ...
    <>
      ...
      <div className="auth-page">
        ...
        <div className="auth-footer">
          <p>
            Déjà un compte ?{' '}
            <Link to={`/auth/login?returnTo=${encodeURIComponent(appBackTarget)}`} className="auth-link">
              Se connecter
            </Link>
          </p>
        </div>
