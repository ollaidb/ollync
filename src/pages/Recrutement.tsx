...
const Recrutement = () => {
  ...
  const defaultSubMenus = getDefaultSubMenus('recrutement')
  ...
  const fetchSubMenus = async () => {
    const subMenusData = await fetchSubMenusForCategory('recrutement')
      ...
      <div className="category-page">
        ...
        <div className="category-header-fixed">
          <div className="category-header-content">
            <BackButton />
            <h1 className="category-title">Recrutement</h1>
        ...
        <div className="category-submenu-fixed">
          <SubMenuNavigation category="recrutement" subMenus={subMenus} />
        </div>
