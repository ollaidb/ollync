 ...
 * Utilise l'API Supabase pour créer le bucket et configurer les politiques
 */
...
const SUPABASE_SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFibXR4dnl5Y3Nsc2ttbm1sbmlxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgyOTAyNDYsImV4cCI6MjA2Mzg2NjI0Nn0.oUz9VQxd5waFJ6Hoj1c5AcvrcqnqYnGYa6iMTUOYumU';
...
/**
 * Fonction principale - crée le bucket et les politiques
 */
async function main() {
  console.log('🚀 Création du bucket Supabase Storage "posts"...\n');
  ...
  // Note: Supabase ne permet pas l'exécution SQL directe via REST API
